              ...
              {options.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "flex w-full cursor-default items-center justify-between gap-2 rounded-lg px-3 py-2 text-left text-sm font-semibold",
                      isSelected
